    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-8">
              ...
              $id=$_GET['id'];
              ?>
                <form action="http://localhost/erp/customer/update.php?id=<?php echo $id; ?>" method="POST">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="id" class="form-label fw-bold">Customer Id:</label>
                            <input type="text" name="id" id="id" style="border-color:black;"  class="form-control" value="<?php echo $_GET['customer'];?>">
                        </div>
                        <div class="col-md-6">
