...
<div class="container mt-5">
    <div class="row">
        <h5><a href="table.php" style="text-decoration:none;"><i class="bi bi-journal-richtext"></i> Payment Report</a></h5>
        <hr>
        <nav class="my-3">
            <ol class="breadcrumb">
        ...
        <div class="col-md-8">
            <form action="http://localhost/erp/payment/create.php" method="POST">
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label for="bill" class="form-label fw-bold">Bill No:</label>
                        <?php 
                        include("../dbconfig.php");
                        $query = "SELECT bill_no FROM purchase2";
                        ...
                        <a href="../purchase/table.php" style="text-decoration:none;">Add Purchase</a>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="paid" id="paid" style="border-color:black;" class="form-control" placeholder="Enter Paid Amount">
                    </div>
                    <div class="col-md-6">
