    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-8">
              ...
              $id=$_GET['id'];
              ?>
                <form action="http://localhost/erp/payment/update.php?id=<?php echo $id; ?>" method="POST">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="paid" id="paid" style="border-color:black;" class="form-control" value="<?php echo $_GET['paid'];?>">
                            <input type="hidden" name="paid1" id="paid1" class="form-control" value="<?php echo $_GET['paid'];?>">
                        </div>
                        <div class="col-md-3">
