...
<html lang="en">
  <head>
    ...
    <title>Cah To Bank Report</title>
...
<?php include("../float.php");?>
    <div class="container mt-5">
        <div class="row">
            <div class="d-flex justify-content-between">
                ...
                <a href="index.php" class="btn btn-primary"><i class="bi bi-plus-circle"></i> New Cash To Bank</a>
            </div>
  ...
  <script>
     fetch("http://localhost/erp/c2b/read.php").then(
            res => {
                res.json().then(
                    data => {
        ...
        $(document).on('click','#delete',function(){
                ...
                if(confirmation){
                    var deleteURL="http://localhost/erp/c2b/delete.php?id="+id+'&amnt='+amnt;
                    $.ajax({
                        url:deleteURL,
                        method:'DELETE',
                        success:function(){
        ...
        if(confirmation){
            window.location.href="http://localhost/erp/c2b/form_update.php?id="+ id +
