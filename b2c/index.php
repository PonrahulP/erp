...
<html lang="en">
 ...
 <?php include("../navbar.php");?>
    <div class="container mt-5">
        <div class="row">
            <h5><a href="table.php" style="text-decoration:none;"><i class="bi bi-journal-richtext"></i> Withdraw Report</a></h5>
            <hr>
            <nav class="my-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Bank To Cash </li>
                </ol>
            </nav>
            <div class="col-md-8">
                <form action="http://localhost/erp/b2c/create.php" method="POST">
