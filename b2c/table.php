...
<html lang="en">
  <head>
    ...
    <title>Bank To Cash Report</title>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="d-flex justify-content-between">
                ...
                <a href="index.php" class="btn btn-primary"><i class="bi bi-plus-circle"></i> New Bank To Cash</a>
            </div>
  ...
  <script>
     fetch("http://localhost/erp/b2c/read.php").then(
            res => {
                res.json().then(
                    data => {
        ...
        $(document).on('click','#delete',function(){
                ...
                if(confirmation){
                    var deleteURL="http://localhost/erp/b2c/delete.php?id="+id+'&amnt='+amnt;
                    $.ajax({
                        url:deleteURL,
                        method:'DELETE',
                        success:function(){
        ...
        if(confirmation){
            window.location.href="http://localhost/erp/b2c/form_update.php?id="+ id +
