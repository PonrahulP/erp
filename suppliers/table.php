...
<div class="container mt-5">
        <div class="row">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a href="index.php" class="btn btn-primary"><i class="bi bi-plus-circle"></i> New Suppliers</a>
            </div>
...
$(document).ready(function() {
     ...
     fetch("http://localhost/erp/suppliers/read.php").then(
            res => {
                res.json().then(
                    data => {
                        if(data.data.length > 0){
                            ...
                            data.data.forEach((itemData)=>{
                                ...
                                temp +="<td>" + itemData.supplier_id+"</td>";
        ...
        $(document).on('click','#delete',function(){
                ...
                if(confirmation){
                    var deleteURL="http://localhost/erp/suppliers/delete.php?id="+id;
                    $.ajax({
                        url:deleteURL,
                        method:'DELETE',
                        success:function(){
        ...
        if(confirmation){
            window.location.href="http://localhost/erp/suppliers/form_update.php?id="+ id +
            "&supplier=" + encodeURIComponent(lastClickedCustomer.supplier) +
